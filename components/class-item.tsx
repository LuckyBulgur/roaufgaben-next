...
const ClassItem: FC<ClassProps> = (props: ClassProps) => {
    return (
        <Link href={'/tasks/' + props.data.id} passHref>
            <div className="w-auto mr-2 h-24 mt-4 rounded-xl bg-myblue backdrop-blur-xl bg-opacity-70 dark:bg-opacity-40 hover:border-green-600 hover:cursor-pointer border-2 text-fontwhite ml-4" key={props.data.id}>
