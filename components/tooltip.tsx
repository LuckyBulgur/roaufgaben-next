...
const Tooltip: FC<TooltipProps> = ({ children, text }) => {
    return (
        <div className="relative group w-full">
            <div className="transition-all flex justify-center items-center w-full flex-col opacity-0 left-auto group-hover:opacity-100 absolute bottom-0 group-hover:bottom-full">
